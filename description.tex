...
\quad
\subfigure{\includegraphics[width=0.47\textwidth]{figures/zeta.eps}}
}
...
\rory{Enumerate what is out there to analyze}.  We need $\alpha$ for $R_{crit}$, and ages for $Q$.
...
\item {\bf Observations and theoretical investigations related to the formation 
  ...
  current minimum eccentricity distrubtion as a function of orbital
  period and planetary radius.  These data will be combined with
  extensive and novel theoretical analysis to constrain the initial
  conditions and evolution of these systems.  This proposal will place
  constraints on model parameters $R_{crit}$, $Q_{r}$ and $Q_{g}$,
  empirically constraining the theory of tidal circularization.
