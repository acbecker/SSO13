...
typical short--period system having 500 transits \andy{How many
quarters are there, and how many transits for 5 day period}, this
comes out to approximately 35 CPU--days of analysis.  The {\tt emcee}
code is natively able to use multiprocessing capabilities, making this
trivial to implement on a multi--core system.  However, with {\tt XXX}
systems on our analysis path, this will require {\tt YYY} CPU--years
