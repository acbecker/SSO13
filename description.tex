...
value of $\tau = 0.051_{0.002}^{0.003}$.  This may be contrasted to a
value $\tau = 0.049 \pm 0.003 $ derived from
...
5.71484_{0.00015}^{0.00009}$.  The uncertainty in the period scales as
a power law with an e--folding timescale of approximately 15 transits.
This may be contrasted to $P = 5.714932 \pm 0.000009$ days reported
in \cite{2013arXiv1304.7387B}.  The differences in $e_{min}$ are more
substantial.  Using their reported value of $\alpha = 18.7 \pm 0.5$,
we derive $e_{min} = 0.043 \pm 0.009$, while we find $e_{min} =
0.021 \pm 0.005$ using the \cite{2013arXiv1304.7387B} results.  
...
entirely consistent with our results from KOI 701.01, where the host
star's magnitude is 13.6, the transit depth is 0.04\%, and measured
S/N in $\tau$ is $\sim$ 7.8 after modeling 10 transits:
...
to follow the analysis path leading to a given scientific results, and
