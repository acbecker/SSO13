...
separation relative to the stellar radius, $\alpha = a / R_{s}$, to
...
We plan to use the information available in the literature to derive
...
described above), we will produce a catalogue of $\alpha = a/R_{s}$
